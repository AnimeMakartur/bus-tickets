...
export const routesArray: Route[] = [
    ...
    new Route(5, "Route 5", busesArray[0], new DateTime(new Date("2024-06-05T12:00:00"), new Date("2024-06-05T16:00:00"), new Date("2024-06-05T14:00:00"), new Date("2024-06-05T14:30:00")), 90, citiesArray[4], citiesArray[0])
];